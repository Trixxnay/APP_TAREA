...
public class TaskAdapter extends RecyclerView.Adapter<TaskAdapter.TaskViewHolder> {
    ...
    public void onBindViewHolder(@NonNull TaskViewHolder holder, int position) {
        ...
        holder.mTextViewDate.setText("Fecha: "+currentItem.getDate());
        holder.mTextViewTime.setText("Hora: "+currentItem.getTime());
        holder.text_category.setText("Categoria: "+currentItem.getCategory());
        holder.text_priority.setText("Priorioridad: "+currentItem.getPriority());
        holder.text_notes.setText("Nota: "+currentItem.getNotes());
    }
